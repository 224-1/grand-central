...
return (new CustomEvent(event_name,(function (){var obj31879 = {"detail":data};
return obj31879;
})()));
} else {
...
var f = (function (){var pred__31886 = cljs.core._EQ_;
var expr__31887 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31886.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31887))){
return ((function (pred__31886,expr__31887){
return (function (p1__31880_SHARP_){
return console.warn(p1__31880_SHARP_);
});
;})(pred__31886,expr__31887))
} else {
if(cljs.core.truth_(pred__31886.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31887))){
return ((function (pred__31886,expr__31887){
return (function (p1__31881_SHARP_){
return console.debug(p1__31881_SHARP_);
});
;})(pred__31886,expr__31887))
} else {
if(cljs.core.truth_(pred__31886.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31887))){
return ((function (pred__31886,expr__31887){
return (function (p1__31882_SHARP_){
return console.error(p1__31882_SHARP_);
});
;})(pred__31886,expr__31887))
} else {
return ((function (pred__31886,expr__31887){
return (function (p1__31883_SHARP_){
return console.log(p1__31883_SHARP_);
});
;})(pred__31886,expr__31887))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31890){
...
var eval_fn = cljs.core.get.call(null,map__31891__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31893_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31895,(0),null);
var v = cljs.core.nth.call(null,vec__31895,(1),null);
...
if(cljs.core.truth_((function (){var and__4036__auto__ = (((typeof localStorage !== 'undefined')) && ((!((goog.object.get(localStorage,"getItem") == null)))));
if(and__4036__auto__){
...
//# sourceMappingURL=utils.js.map?rel=1564575463955
