...
var G__26008 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26008;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26009 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26009,ch);
...
if(("\\" === ch__$1)){
var ch_26010__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26010__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26010__$2);
} else {
}

var G__26011 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26011;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__4047__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__4047__auto__){
...
var vec__26019 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26019,(0),null);
var start_column = cljs.core.nth.call(null,vec__26019,(1),null);
...
var G__26022 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26022;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26023 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26024 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26024;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26023;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26025 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26025,(0),null);
var start_column = cljs.core.nth.call(null,vec__26025,(1),null);
...
var vec__26028 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26028,(0),null);
var end_column = cljs.core.nth.call(null,vec__26028,(1),null);
...
var vec__26031 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26031,(0),null);
var start_column = cljs.core.nth.call(null,vec__26031,(1),null);
...
var vec__26034 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26034,(0),null);
var end_column = cljs.core.nth.call(null,vec__26034,(1),null);
...
var vec__26037 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26037,(0),null);
var start_column = cljs.core.nth.call(null,vec__26037,(1),null);
...
var vec__26040 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26040,(0),null);
var end_column = cljs.core.nth.call(null,vec__26040,(1),null);
...
var sb = (function (){var G__26043 = (new goog.string.StringBuffer());
G__26043.append(initch);
...
var G__26045 = (function (){var G__26044 = sb;
G__26044.append(ch);

return G__26044;
})();
var G__26046 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26045;
ch = G__26046;
continue;
}
...
switch (G__26049) {
case "\\":
var G__26053 = (function (){var G__26050 = sb;
G__26050.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26050;
})();
var G__26054 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26053;
ch = G__26054;
continue;
...
break;
default:
var G__26055 = (function (){var G__26051 = sb;
G__26051.append(ch);

return G__26051;
})();
var G__26056 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26055;
ch = G__26056;
continue;
...
var vec__26057 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26057,(0),null);
var end_column = cljs.core.nth.call(null,vec__26057,(1),null);
...
var vec__26060 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26060,(0),null);
var column = cljs.core.nth.call(null,vec__26060,(1),null);
...
var vec__26065 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26065,(0),null);
var column = cljs.core.nth.call(null,vec__26065,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__4036__auto__ = line;
...
var vec__26070 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26070,(0),null);
var column = cljs.core.nth.call(null,vec__26070,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26075 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26075,(0),null);
var start_column = cljs.core.nth.call(null,vec__26075,(1),null);
...
var vec__26078 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26078,(0),null);
var end_column = cljs.core.nth.call(null,vec__26078,(1),null);
...
var G__26081 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26081,true,null,opts,pending_forms);
...
var G__26082 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26082)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26082)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26082)){
...
if((form === cljs.tools.reader.READ_EOF)){
return cljs.tools.reader.impl.errors.throw_eof_error.call(null,rdr,(function (){var and__4036__auto__ = (first_line < (0));
...
var _STAR_suppress_read_STAR__orig_val__26083 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26084 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26084;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26083;
}});
...
var G__26085 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26085,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26085,rdr,first_line);
...
var G__26089 = matched;
var G__26090 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26089;
finished = G__26090;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__4036__auto__ = opts;
if(cljs.core.truth_(and__4036__auto__)){
...
var _STAR_suppress_read_STAR__orig_val__26091 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26092 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26092;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26091;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26093 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26094 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__26094;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26095 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26095,"(");
...
var G__26096 = (i + (1));
var G__26097 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__26093;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26098 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26098);
...
var G__26099 = cljs.core.next.call(null,s__$1);
var G__26100 = ret;
s__$1 = G__26099;
r = G__26100;
continue;
...
var G__26101 = cljs.core.next.call(null,s);
var G__26102 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26101;
key_vals = G__26102;
continue;
} else {
...
if((function (){var and__4036__auto__ = (((!((form == null))))?(((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || ((cljs.core.PROTOCOL_SENTINEL === form.cljs$core$IWithMeta$))))?true:false):false);
if(and__4036__auto__){
...
return cljs.tools.reader.add_meta.call(null,form,((cljs.core.special_symbol_QMARK_.call(null,form))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,form,null,(1),null)),(2),null)):(((form instanceof cljs.core.Symbol))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,(cljs.core.truth_((function (){var and__4036__auto__ = cljs.core.not.call(null,cljs.core.namespace.call(null,form));
if(and__4036__auto__){
...
var gensym_env_orig_val__26106 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26107 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__26107;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__26106;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26108 = token;
var G__26108__$1 = (((G__26108 == null))?null:cljs.core.subs.call(null,G__26108,(1)));
var G__26108__$2 = (((G__26108__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26108__$1));
var G__26108__$3 = (((G__26108__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26108__$2));
var G__26108__$4 = (((G__26108__$3 == null))?null:cljs.core.symbol.call(null,G__26108__$3));
if((G__26108__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26108__$4);
}
})():(function (){var G__26109 = token;
var G__26109__$1 = (((G__26109 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26109));
if((G__26109__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26109__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
var temp__5718__auto__ = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26120,reader){
...
var eof = cljs.core.get.call(null,map__26121__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___26129 = arguments.length;
var i__4642__auto___26130 = (0);
while(true){
if((i__4642__auto___26130 < len__4641__auto___26129)){
args__4647__auto__.push((arguments[i__4642__auto___26130]));

var G__26131 = (i__4642__auto___26130 + (1));
i__4642__auto___26130 = G__26131;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26127){
var G__26128 = cljs.core.first.call(null,seq26127);
var seq26127__$1 = cljs.core.next.call(null,seq26127);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26128,seq26127__$1);
});


//# sourceMappingURL=reader.js.map?rel=1564575451966
